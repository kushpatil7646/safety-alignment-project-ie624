#!/bin/bash
#SBATCH --job-name=bdoor_ablate_s1
...
#SBATCH --output=/users/student/idddp/kushpatil/Safety_algn/logs/ablate_s1_%j.out

set -e

echo "======================================================"
echo "ABLATION: skip Stage 1 (KL divergence)"
...
mkdir -p logs results_gpu_ablate_s1
...
python3 -m src.evaluate \
    ...
    --skip-stages 1 \
    --output-dir results_gpu_ablate_s1 \
    --log-level INFO

echo ""
echo "======================================================"
echo "Ablation skip-S1 complete: $(date)"
echo "Results in: results_gpu_ablate_s1/"
echo "======================================================"
